...
# Kernel
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom user_debug=31 zcache msm_rtb.filter=0x3F ehci-hcd.park=3 enforcing=0 selinux=0 androidboot.bootdevice=msm_sdcc.1
